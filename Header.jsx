    ...
    <>
      ...
      >
        <div className="h-14 px-4 flex items-center justify-between">
          <Link to="/" className="shrink-0" aria-label="UGR home">
            <img
              src="/ugrlogo.png"
              alt="UGR"
              width={56}
          ...
          <nav className="flex items-center gap-1">
            ...
            <Link
              ...
              "
            >
              <img src="/cart-icon.svg" alt="" width={24} height={24} />
              {cartCount > 0 && (
                <span
                  className="
            ...
            <button
              ...
              "
            >
              <img src="/search-icon.svg" alt="" width={24} height={24} />
            </button>
            ...
            <button
              ...
              "
            >
              <img src="/hamburger-menu.svg" alt="" width={24} height={24} />
            </button>
          </nav>
        </div>
      </header>
    ...
    >
      ...
      >
        <div className="h-14 px-4 flex items-center justify-between border-b">
          ...
          >
            <img src="/icons/close.svg" alt="" width={22} height={22} />
          </button>
        </div>

        <nav className="px-2 py-2">
          <MenuItem to="/categories">Shop by Category</MenuItem>
          <MenuItem to="/vehicles">Shop by Vehicle</MenuItem>
          <MenuItem to="/new">New Arrivals</MenuItem>
          <MenuItem to="/best-sellers">Best Sellers</MenuItem>
...
function MenuItem({ to, children }) {
  return (
    ...
    >
      <span>{children}</span>
      <img src="/icons/chevron-right.svg" alt="" width={18} height={18} />
    </Link>
  );
}
